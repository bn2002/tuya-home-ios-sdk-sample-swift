Pod::Spec.new do |s|
  ...
  s.ios.source_files = 'TuyaSmart/ThingSmartCryption.xcframework/ios*simulator/ThingSmartCryption.framework/Headers/*'
  s.resources = 'TuyaSmart/ThingSmartCryption.xcframework/ios*simulator/**/*.bundle'

  s.watchos.source_files = 'TuyaSmart/ThingSmartCryption.xcframework/watchos*simulator/ThingSmartCryption.framework/Headers/*'

  s.vendored_frameworks = 'TuyaSmart/ThingSmartCryption.xcframework'
